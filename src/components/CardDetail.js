				...
				<div className="uk-container uk-text-lead uk-text-left text-primary">
					<div uk-grid="true" className="uk-grid-large uk-child-width-expand@s uk-margin-large-top">
						<div className="uk-width-1-2@s">
							<h1 className="text-primary crypto-header">
								<span>{this.state.coin['USD'].FROMSYMBOL}</span>
								{this.state.coin['USD'].CHANGE24HOUR > 0 ? (
									<span className="uk-text-lead uk-text-success">
										<NumberFormat
											className="pct-container"
											value={parseFloat(this.state.coin['USD'].CHANGEPCT24HOUR).toFixed(2)}
											suffix="%)"
											prefix="("
											displayType={'text'}
											decimalScale={2}
									...
									<span className="uk-text-lead uk-text-danger">
										<NumberFormat
											className="pct-container"
											value={parseFloat(this.state.coin['USD'].CHANGEPCT24HOUR).toFixed(2)}
											suffix="%)"
							...
							<div uk-grid="true" className="uk-margin-large-top uk-grid-large uk-child-width-expand@s">
								<div className="uk-width-1-2@s">
									<div className="uk-text-left uk-margin-medium-bottom">
										<span>Current Price:</span>
										<h3 className="heading-tertiary">
											<NumberFormat
												className="pct-container"
												value={parseFloat(this.state.coin['USD'].PRICE).toFixed(2)}
												prefix="$ "
												displayType={'text'}
												decimalScale={2}
											/>
									...
									<div className="uk-text-left">
										...
										<h3 className="heading-tertiary">
											<NumberFormat
												className="pct-container"
												value={parseFloat(this.state.coin['USD'].VOLUME24HOUR).toFixed(2)}
												displayType={'text'}
												decimalScale={2}
											/>
										</h3>
								...
								<div className="uk-width-1-2@s">
									<div className="uk-text-left uk-margin-medium-bottom">
										...
										<h3 className="heading-tertiary">
											<NumberFormat
												className="pct-container"
												value={parseFloat(this.state.coin['USD'].MKTCAP).toFixed(2)}
												displayType={'text'}
												decimalScale={2}
											/>
										</h3>
									...
									<div className="uk-text-left">
										...
										<h3 className="heading-tertiary">
											<NumberFormat
												className="pct-container"
												value={parseFloat(this.state.coin['USD'].VOLUMEHOUR).toFixed(2)}
												displayType={'text'}
												decimalScale={2}
											/>
										</h3>
